...
// Internal public key package used by the group; not exposed outside this module tree.
...
impl FrostPublicKeyPackage {
    ...
    pub(super) fn from_frost(pkg: &frost_secp256k1_tr::keys::PublicKeyPackage) -> AnyResult<Self> {
    ...
    pub(super) fn to_frost(&self) -> AnyResult<frost_secp256k1_tr::keys::PublicKeyPackage> {
        use anyhow::anyhow;
        use frost_secp256k1_tr::keys::VerifyingShare;
        use frost_secp256k1_tr::VerifyingKey;
        ...
        Ok(frost_secp256k1_tr::keys::PublicKeyPackage::new(vshares, verifying_key))
    }
}
